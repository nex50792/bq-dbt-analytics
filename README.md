...
- ダッシュボード (Evidence.dev): https://<VERCEL_URL>  ※ Vercel デプロイ後に更新
- 系統図 (dbt docs): https://<GITHUB_USER>.github.io/bq-dbt-analytics/  ※ GitHub Pages 有効化後
- ソースコード: https://github.com/<GITHUB_USER>/bq-dbt-analytics
...
- 公開 URL: https://<GITHUB_USER>.github.io/bq-dbt-analytics/
